<template>
    ...
    <div class="container">
        ...
        <z-navbar v-nav="{title: '水平 (默认)', showBackButton: true}"></z-navbar>

        <div class="page has-navbar">
            <div class="page-content">
                <swiper ref="swiper" direction="horizontal" width="100%" height="150" pager-color="#ea5a49"
                        pager-bg-color="#e5e4e3" :callback="callback">
                    <swiper-item>
                ...
                <div class="item item-borderless item-icon-right" thin-border
                     @click="$router.push('/advanced/swiper/vertical')">
